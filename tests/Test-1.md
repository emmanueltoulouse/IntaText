...
Paragraphe simple avec texte courant.
Deux espaces à la fin pour forcer un saut de ligne
...
• Gras + italique: ***gras+italique*** et **_gras+italique_**

• Barré: ~~barré~~

• Souligné (HTML): <u>souligné</u>

• Combinaisons imbriquées: **gras et _italique_ imbriqué** et <u>souligné avec **gras**</u>

• Caractères échappés: \*pas italique\*, \_pas italique\_, \~pas barré\~, \`pas code\`

• Souligné avec contenu riche: <u>texte <em>italique</em> et <strong>gras</strong></u>
...
• Image simple: ![Logo](images/logo.png "Titre de l’image")

• Image distante: ![PNG distant](https://via.placeholder.com/100x50.png)
...
Paragraphe avec inline HTML: <span style="color: red;">rouge</span> et souligné.
