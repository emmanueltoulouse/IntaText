...
using IntaText; // Ajouter le namespace IntaText pour accéder à ApplicationController

public class CommandView {
    // Contrôleur de l'application
    private IntaText.ApplicationController? controller;
     ...
     */
    public CommandView(IntaText.ApplicationController controller) {
