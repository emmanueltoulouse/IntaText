...
public ConfigManager() {
    ...
    config_path = Path.build_filename(Environment.get_user_config_dir(), "intatext", "config.ini");

    // Répertoire personnel pour l'application
    app_home_dir = Path.build_filename(Environment.get_home_dir(), "com.cabineteto.IntaText");
