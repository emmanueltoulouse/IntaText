...
namespace IntaText {
    ...
    public class TerminalView : Gtk.Box {
        ...
        private const string PROMPT = "intatext> ";
        ...
        private void print_welcome_message() {
            ...
            buffer.insert_markup(ref end_iter,
                "<span foreground='#4ec9b0'>IntaText Terminal v0.1.0</span>\n" +
        ...
        public bool check_entry_state() {
            ...
            print("État du terminal: can_focus=%s, editable=%s\n",
                  can_focus.to_string(), is_editable.to_string());
