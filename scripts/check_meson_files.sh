...
check_file "data/intatext.gresource.xml" || ((RESOURCES_MISSING++))
check_file "data/icons/hicolor/scalable/apps/com.cabineteto.IntaText.png" || ((RESOURCES_MISSING++))
check_file "data/com.cabineteto.IntaText.desktop.in" || ((RESOURCES_MISSING++))
